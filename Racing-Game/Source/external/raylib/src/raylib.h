...
//RLAPI void SetKey(int key, bool state);                     // Set key state manually, current frame
...
//RLAPI void SetGamepadButton(int gamepad, int button, int state);
...
//RLAPI void SetMouseButton(int button, bool state);
